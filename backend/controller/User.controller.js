...
const OrderClick = async (req, res) => {
  ...
  const Myproduct = async(req,res)=>{
       try {
          const {OrderId,TrackingCompnay,TrackingId,Otp,FourDigit,AppId} = req.body
          const Invoice = `/images/${req.file.filename}`
  ...
  export default {EmailRegister,OtpVerfiy,UserData,ResndOtp,OrderClick,Myproduct,Deals,UserCheck,SingleDeal,Kyc}
